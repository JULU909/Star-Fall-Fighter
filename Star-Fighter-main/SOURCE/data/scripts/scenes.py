...
class TitleScene(Scene):
    ...
    def draw(self, window):
        ...
        draw_text(window, "Harish Vasanth", int(FONT_SIZE/2), GAME_FONT, window.get_rect().centerx, window.get_rect().bottom-24, "WHITE", "centered")
...
class CreditsScene(Scene):
    ...
    def draw(self, window):
        ...
        draw_text2(window, "Harish Vasanth", GAME_FONT, FONT_SIZE, (WIN_RES["w"]/2, WIN_RES["h"]*0.270), "YELLOW", align="center")
        draw_text2(window, "code", GAME_FONT, FONT_SIZE, (WIN_RES["w"]/2, WIN_RES["h"]*0.300), "WHITE", align="center")
